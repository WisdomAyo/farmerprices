                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="topbar-right ml-auto">
                        <ul class="list-inline mb-0">
                            ...
                            <li class="list-inline-item mr-0 u-header-topbar__nav-item u-header-topbar__nav-item-border">
                                <a href="{{url("/")}}" class="btn btn-primary transition-3d-hover rounded-lg  py-2 px-md-7 px-3 "
                                    ...
                                    <div class="u-header-sidebar__footer-offset pb-0">
                                        ...
                                        <div class="js-scrollbar u-sidebar__body">
                                            <div id="headerSidebarContent" class="u-sidebar__content u-header-sidebar__content">
                                                <!-- Logo -->
                                                <a class="d-flex ml-0 navbar-brand u-header__navbar-brand u-header__navbar-brand-vertical" href="{{url('/')}}" aria-label="">
                                                    FARMERS PRICE
                                                </a>
                                                <!-- End Logo -->
                            ...
                            <ul class="d-flex list-unstyled mb-0 align-items-center">
                                ...
                                <li class="col pr-xl-0 px-2 px-sm-3">
                                    <a href="../shop/cart.html" class="text-gray-90 position-relative d-flex " data-toggle="tooltip" data-placement="top" title="Cart">
                                        ...
                                        @if($cart)
                                            @foreach($cart  as $row)
                                        <span class="width-22 height-22 bg-dark position-absolute d-flex align-items-center justify-content-center rounded-circle left-12 top-8 font-weight-bold font-size-12 text-white">{{$row['quantity']}}</span>
                                        <span class="d-none d-xl-block font-weight-bold font-size-16 text-gray-90 ml-3">₦{{ number_format($row['price'])}}</span>
                                            @endforeach
                                        @else
                                            ...
                                            <span class="d-none d-xl-block font-weight-bold font-size-16 text-gray-90 ml-3">00.00</span>
                                        @endif
                                    </a>
                                </li>
                            </ul>
                                    ...
                                    <div id="basicsCollapseOne" class="collapse show vertical-menu v1"
                                        ...
                                        <style>
                                            .b-post-advert-banner {
                                                ...
                                                -webkit-box-shadow: 0 1px 2px rgba(96,125,135,.15);
                                                box-shadow: 0 1px 2px rgba(96,125,135,.15);
                                            }
                                            .b-post-advert-banner p{
                                                background-color: #ffa010;
                                                padding: 2px;
                                                font-weight: bolder;;
                                                text-align: center;
                                            ...
                                            .b-post-advert-banner__button {
                                                ...
                                                width: 50%;
                                                cursor: pointer;
                                                -webkit-box-shadow: 1px 1px 4px rgba(80,114,125,.4);
                                            ...
                                            .b-post-advert-banner__button_inner:after, .b-post-advert-banner__button_inner:before {
                                                content: "";
                                                background-color: #ffa010;
                                                position: absolute;
                                                margin: auto;
                                            ...
                                            .b-trending-card__boosted-label {
                                                position: absolute;
                                                top: 0;
                                                left: 0;
                                                width: 68px;
                                                height: 18px;
                                                -webkit-border-radius: 4px 0 8px;
                                        ...
                                        <div class="b-main-page__banners-block__banner">
                                            <div class="b-post-advert-banner b-main-page__post-advert-banner">
                                                <p>
                                                    Got something to sell?
                                                </p> <button class="b-post-advert-banner__button"><i class="fa fa-plus fa-8x" style="color: #ffa010;"></i> </button> <p class="b-post-advert-banner__bottom-text">
