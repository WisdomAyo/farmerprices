            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="page-title mb-0 font-size-18">All Category</h4>
...
{{--                                        <th>&nbsp;</th>--}}
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-info" href="{{URL('admin/categories/editing/'.$row->id)}}">
                                        ...
                                        <td>
                                            ...
                                            @if($row->status_id == 1)
                                                <form class="form-horizontal " action="{{ route('enabling.category')}}" method="post">
                                                    {{ csrf_field() }}
...
{{--                                        <td>--}}
{{--                                            <form class="form-horizontal "action="{{ route('delete.category.now')}}" method="post">--}}
{{--                                                {{ csrf_field() }}--}}
{{--                                                <input name="action" value="delete" type="hidden" />--}}
{{--                                                <input name="id" value="{{$row->id}}" type="hidden" />--}}
{{--                                                <input name="status_answer" value="1" type="hidden">--}}
